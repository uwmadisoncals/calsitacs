		...
		<main id="main" class="site-main" role="main">
  			<section class="error-404 not-found">
				<header class="page-header">
					<h1 class="page-title"><?php _e( 'Oops! That page can&rsquo;t be found.', 'calsboilerplate_underscores' ); ?></h1>
				</header><!-- .page-header -->
				...
				<div class="page-content">
					...
					<?php if ( calsboilerplate_underscores_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>
					<div class="widget widget_categories">
						<h2 class="widget-title"><?php _e( 'Most Used Categories', 'calsboilerplate_underscores' ); ?></h2>
						<ul>
						<?php
