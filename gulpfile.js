...
gulp.task('scripts', function() {
  return gulp.src(['./js/jquery-2.1.3.js','./js/jquery.tooltipster.min.js','./js/velocity.js','./js/velocity.ui.js','./js/CALSboilerplate_underscores_custom.js','./js/parallax.js','./js/tabs.js','./js/menu.js','./js/page-home.js'])
    .pipe(concat('main.js'))
