...
gulp.task('scripts', function() {
  return gulp.src(['./js/jquery-2.1.3.js','./js/velocity.js','./js/velocity.ui.js','./js/tipped.js','./js/CALSboilerplate_underscores_custom.js','./js/parallax.js','./js/tabs.js','./js/menu.js'])
    .pipe(concat('main.js'))
